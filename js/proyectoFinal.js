        ...
        if(opcion === 1){
            ...
            if(cuotas === 3 || cuotas === 6 || cuotas === 12){
                if(cuotas === 3){
                    ...
                    console.log("Su monto final es " + (montoFinal) + " debe pagar 3 cuotas de " + (montoFinal)/3)
                }
                else if(cuotas === 6){
                    let monto = parseInt(prompt("Ingrese el monto que debe abonar"));
                    let montoFinal = 0
                    ...
                    console.log("Su monto final es " + (montoFinal) + " debe pagar 6 cuotas de " + (montoFinal)/6)
                }
                else if(cuotas === 12){
                    let monto = parseInt(prompt("Ingrese el monto que debe abonar"));
                    let montoFinal = 0
                    ...
                    console.log("Su monto final es " + (montoFinal) + " debe pagar 12 cuotas de " + (montoFinal)/12)
                }else{
                    alert("Error");
                }
            }
            ...
            if(cuotas === 3 || cuotas === 6 || cuotas === 12){
                if(cuotas === 3){
                    ...
                    console.log("Su monto final es " + monto + " debe pagar 3 cuotas de " + (monto/3))
                }
                else if(cuotas === 6){
                    let monto = parseInt(prompt("Ingrese el monto que debe abonar"));
                    while(monto  != "ESC"){
                    ...
                    console.log("Su monto final es " + monto + " debe pagar 6 cuotas de " + (monto/6))
                }
                else if(cuotas === 12){
                    let monto = parseInt(prompt("Ingrese el monto que debe abonar"));
                    while(monto  != "ESC"){
                    ...
                    console.log("Su monto final es " + monto + " debe pagar 12 cuotas de " + (monto/12))
                }else{
                    alert("Error");
                }
            }
            ...
            console.log("Su monto final es " + monto)
        }
    }else{
